...
/**
 * Created by RYZEN on 08.01.2018.
 */

public class StoneBlock extends PlanetBoundBlock {
     ...
     */
    public StoneBlock(World world, Game game) {
        super(world, game);
        ...
        String colorpack_region_name = world.getPlanetProperties().PLANET_TYPE.BLOCKS_PROPERTIES.getBlockProperties(StoneBlock.class).COLOR_PACK_REGION_NAME;
        ...
        TextureRegion[][] textures = game.getAssetsManager().getTextureRegion("blocks/stone_spritesheet").split(BLOCK_PIXEL_SIZE, BLOCK_PIXEL_SIZE);
